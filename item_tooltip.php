...
<?php
	...
	//durability
?>
	<p><span class="item_tooltip_label_text">Dura</span> <?=$item['total_durability']?>/<?=$item['total_durability']?></p>
<?php
	if ($item['weapon_type']) {
?>
...
?>
	<p class="item_tooltip_synth_avail_text">Synthesis Available<br />(~<?=$grades_text[$item['max_grade']]?>)</p>
<?php
		}
	}
...
?>
	...
	<p class="item_tooltip_equip_effects_text">
		<span class="item_tooltip_equip_effects_text">Equip Effect</span><br /><?=$equip_effect_text?> <span class="item_tooltip_equip_effect_amount"><?=$item['equip_effect_1_amount']?></span>
	</p>
<?php
}
...
?>
	<p class="item_tooltip_synth_effects_text"><span class="item_tooltip_synth_effects_label">Synthesis Effect</span><br /><?=$synth_effect_text?> <?=$item['synth_effect_1_amount']?></p>
<?php
}
...
?>
	<p class="item_tooltip_use_effects_text"><span class="item_tooltip_use_effects_label">Use:</span><br /><?=nl2br($use_effect_text)?></p>
<?php
}
